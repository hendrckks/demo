        ...
        <div className="flex flex-col justify-center items-center w-[720px] mt-16">
          {AccordionData.map((data, index) => (
            <div key={index} className="m-auto cursor-pointer">
              ...
              >
                <div className="flex-col bg-[#1d1a27] text-white p-10 rounded-[22px] cursor-pointer transform hover:translate-y-1 transition-transform duration-300 ease-in inset-0 delay-0 shadow-md">
                  <div className="flex items-center justify-between">
                    <h2 className="font-semibold text-[18px] flex items-center ">
                      {data.title}
                    </h2>
                    <div className="text-[24px] flex items-center transition-shadow transform ease-in-out duration-300">
                  ...
                  >
                    <p className="flex items-center justify-center overflow-auto mt-4 text-neutral-400">
                      {data.Description}
                    </p>
                  </div>
                </div>
